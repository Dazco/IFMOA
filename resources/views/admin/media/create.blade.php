...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">Upload Image for Media Gallery</h1>

        <!--Upload Image-->
        {!! Form::open(['method'=>'POST','action'=>'Admin\AdminMediaController@store','files'=>true]) !!}
    ...
    {!! Form::submit('Upload Media',['class'=>'btn btn-primary float-right']) !!}
    {!! Form::close() !!}
        <!--End of upload Image-->
