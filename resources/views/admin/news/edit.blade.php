...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!--Create News-->
        {!! Form::model($news,['method'=>'PATCH','action'=>['Admin\AdminNewsController@update',$news->id],'files'=>true]) !!}
        ...
        <figure class="mt-5">
            <img height="250" width="500" src="{{$news->image}}" alt="Image" class="img-responsive" id="renderImage">
        </figure>
    ...
    {!! Form::submit('Update News',['class'=>'btn btn-primary float-right']) !!}
    {!! Form::close() !!}
    <!--End of Create News-->
